...
public class WSRole  extends com.ibm.itim.ws.model.WSObject  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://model.ws.itim.ibm.com", "WSRole"));
